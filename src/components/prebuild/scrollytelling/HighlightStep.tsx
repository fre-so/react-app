...
export function HighlightStepScrollytelling({
  ...
  const normalizedStepRatio =
    typeof stepRatio === 'number' && Number.isFinite(stepRatio) ? Math.min(Math.max(stepRatio, 0), 1) : 0.4;
      ...
      <div className="mx-auto max-w-6xl px-6 py-16" style={{ minHeight: `calc(100vh + ${totalScrollDistance}px)` }}>
        ...
        >
          <div
            ...
            className={cn('flex flex-col gap-10 lg:flex-row lg:items-center', isMediaLeft && 'lg:flex-row-reverse')}
          >
            <div className="w-full space-y-4" style={{ flexBasis: 0, flexGrow: computedStepRatio }}>
                    ...
                    >
                      <button
                        ...
                        className={cn(
                          ...
                          isActive ? 'border-l-4 border-l-primary bg-card shadow-sm' : 'bg-muted/40 hover:bg-muted/60',
                          stepClassName
                        )}
