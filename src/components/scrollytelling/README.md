...
This document explains each component in detail: what it looks like, when to use it, how to use it, and what each prop does (with small examples).
...
Code Path: `src/components/scrollytelling/StickySide.tsx`
...
Code Path: `src/components/scrollytelling/HighlightStep.tsx`
...
## VerticalTimeline
Code Path: `src/components/scrollytelling/VerticalTimeline.tsx`
...
## HorizontalTimeline
Code Path: `src/components/scrollytelling/HorizontalTimeline.tsx`
